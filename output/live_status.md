...
*Generated 2026-07-03. 85 matches recorded (72 group, 13 knockout).*

## 🎯 Our Tippspiel score

**108 points** from 72 scored matches (avg 1.50/match · 8 exact hits). Bonus questions (10 pts each) are tracked separately.

| Match | Our tip | Result | Pts |
|-------|:-------:|:------:|----:|
| Czechia – Mexico | 1–2 | 0–3 | 2 |
| Czechia – South Korea | 1–2 | 1–2 | 4 |
| Czechia – South Africa | 2–1 | 1–1 | 0 |
| Mexico – South Korea | 2–1 | 1–0 | 3 |
| Mexico – South Africa | 2–1 | 2–0 | 2 |
| South Korea – South Africa | 2–1 | 0–1 | 0 |
| Switzerland – Canada | 1–0 | 2–1 | 3 |
...
Remaining tournament re-simulated given results so far, with ratings re-tuned from observed form.
...
- **Safe (default):** expected-points-maximizing tips — best when you're leading or playing the long game.
- **Aggressive (`--risk aggressive`):** tip the most likely *exact* score to maximize 4-point hits — higher variance, use when you need to catch up in your round.
- Re-run after each matchday: results re-tune the ratings and re-simulate the rest, and upcoming tips update automatically.
